...
public class MaksukorttiTest {
	...
	@Test
	public void syoMaukkaastiiEiVieSaldoaNegatiiviseksi(){
		kortti.syoMaukkaasti();
		kortti.syoMaukkaasti();
		kortti.syoMaukkaasti();
		assertEquals("Kortilla on rahaa 2.0 euroa", kortti.toString());
	...
	@Test
	public void korttiinEiVoiLadataNegatiivistaSummaa(){
		kortti.lataaRahaa(-5);
		assertEquals("Kortilla on rahaa 10.0 euroa", kortti.toString());
	}

	@Test
	public void kortillaVoiSyodaVainEdullisen(){
	...
	@Test
	public void kortillaVoiSyodaVainMaukkaan(){
